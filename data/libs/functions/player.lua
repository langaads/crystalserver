...
do
	local loyaltySystem = {
		...
		pointsPerBonusPercent = 5,
		titles = {
			[1] = { name = "Scout of Tibia", points = 5 },
			[2] = { name = "Sentinel of Tibia", points = 10 },
			[3] = { name = "Steward of Tibia", points = 20 },
			[4] = { name = "Warden of Tibia", points = 40 },
			[5] = { name = "Squire of Tibia", points = 100 },
			[6] = { name = "Warrior of Tibia", points = 200 },
			[7] = { name = "Keeper of Tibia", points = 300 },
			[8] = { name = "Guardian of Tibia", points = 400 },
			[9] = { name = "Sage of Tibia", points = 500 },
			[10] = { name = "Savant of Tibia", points = 600 },
			[11] = { name = "Enlightened of Tibia", points = 700 },
		},
	...
	function Player.initializeLoyaltySystem(self)
		...
		-- Bonus
		local playerBonusPercentage = math.floor(playerLoyaltyPoints / loyaltySystem.pointsPerBonusPercent)

		playerBonusPercentage = math.floor(playerBonusPercentage * configManager.getFloat(configKeys.LOYALTY_BONUS_PERCENTAGE_MULTIPLIER))
