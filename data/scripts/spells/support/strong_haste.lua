...
condition:setParameter(CONDITION_PARAM_TICKS, 44000)
	...
	if summons and type(summons) == "table" and #summons > 0 then
		for i = 1, #summons do
			...
			if summon_t and summon_t:familiar() then
				...
				FamiliarHaste:setParameter(CONDITION_PARAM_TICKS, 47000)
...
spell:group("support")
spell:vocation("druid;true", "elder druid;true", "sorcerer;true", "master sorcerer;true", "monk;true", "exalted monk;true", "paladin;true", "royal paladin;true")
