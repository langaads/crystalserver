...
local config = {
	[5907] = { NAME = "Bear", ID = 3, BREAK = false, TYPE = TYPE_MONSTER, CHANCE = 20, FAIL_MSG = { { 1, "The bear ran away." }, { 2, "Oh no! The slingshot broke." }, { 3, "The bear is trying to hit you with its claws." } }, SUCCESS_MSG = "You have tamed the war bear.", ACHIEV = "Bearbaiting" },
	[52638] = { NAME = "Battlefrazzle", ID = 246, BREAK = false, TYPE = TYPE_MONSTER, CHANCE = 40, FAIL_MSG = { { 2, "The tamed frazzlemaw devours the rare fish but otherwise takes no notice of your advancement." } }, SUCCESS_MSG = "The tamed frazzlemaw hungers for fish and this one is a particular rare treat. You command this one now, take good care of it!" },
	[12308] = { NAME = "Black Sheep", ID = 4, BREAK = false, TYPE = TYPE_MONSTER, CHANCE = 25, FAIL_MSG = { { 1, "The black sheep ran away." }, { 2, "Oh no! The reins were torn." }, { 3, "The black sheep is trying to run away." } }, SUCCESS_MSG = "You have tamed the sheep.", ACHIEV = "Little Ball of Wool" },
	[12260] = { NAME = "Boar", ID = 10, BREAK = false, TYPE = TYPE_MONSTER, CHANCE = 40, FAIL_MSG = { { 1, "The boar has run away" }, { 3, "The boar attacks you." } }, SUCCESS_MSG = "You have tamed the boar.", ACHIEV = "Pig-Headed" },
	[12318] = { NAME = "Crustacea Gigantica", ID = 7, BREAK = false, TYPE = TYPE_MONSTER, CHANCE = 40, FAIL_MSG = { { 1, "The crustacea has run away." }, { 2, "The crustacea ate the shrimp." } }, SUCCESS_MSG = "You have tamed the crustacea.", ACHIEV = "Fried Shrimp" },
	[12547] = { NAME = "Crystal Wolf", ID = 16, BREAK = false, TYPE = TYPE_MONSTER, CHANCE = 40, FAIL_MSG = { { 1, "The wolf has run away." } }, SUCCESS_MSG = "You have tamed the wolf.", ACHIEV = "The Right Tone" },
	[12548] = { NAME = "Donkey", ID = 13, BREAK = false, TYPE = TYPE_MONSTER, CHANCE = 40, FAIL_MSG = { { 1, "The donkey transformation suddenly wears off." }, { 2, "Heeee-haaa-haaa-haaw!" }, { 3, "You did not manage to feed the donkey enough apple slices." } }, SUCCESS_MSG = "Heeee-haaaaw!", ACHIEV = "Loyal Lad" },
	[16155] = { NAME = "Dragonling", ID = 31, BREAK = false, TYPE = TYPE_MONSTER, CHANCE = 30, FAIL_MSG = { { 1, "The dragonling got scared and ran away." }, { 2, "The dragonling is trying to nibble." } }, SUCCESS_MSG = "You tamed a dragonling.", ACHIEV = "Dragon Mimicry" },
	[12307] = { NAME = "Draptor", ID = 6, BREAK = false, TYPE = TYPE_MONSTER, CHANCE = 40, FAIL_MSG = { { 1, "The draptor has run away." }, { 3, "The draptor has fled." } }, SUCCESS_MSG = "You have tamed the draptor.", ACHIEV = "Scales and Tail" },
	[12546] = { NAME = "Dromedary", ID = 20, BREAK = false, TYPE = TYPE_MONSTER, CHANCE = 40, FAIL_MSG = { { 1, "Dromedary has run away." } }, SUCCESS_MSG = "You have tamed the dromedary.", ACHIEV = "Fata Morgana" },
	[12550] = { NAME = "Enraged White Deer", ID = 18, BREAK = false, TYPE = TYPE_MONSTER, CHANCE = 40, FAIL_MSG = { { 2, "The cone broke." }, { 3, "The deer has fled in fear." } }, SUCCESS_MSG = "You have tamed the white deer.", ACHIEV = "Friend of Elves" },
	...
	[12305] = { NAME = "inoperative tin lizzard", ID = 8, BREAK = false, TYPE = TYPE_ITEM, CHANCE = 40, FAIL_MSG = { { 2, "The key broke inside." } }, SUCCESS_MSG = "You wind up the tin lizzard.", ACHIEV = "Knock on Wood" },
	[12801] = { NAME = "inoperative uniwheel", ID = 15, BREAK = false, TYPE = TYPE_ITEM, CHANCE = 40, FAIL_MSG = { { 3, "The oil have no effect." }, { 2, "Splosh! It looks like most of the special oil this can was holding was spilt without any effect." } }, SUCCESS_MSG = "Vroooomratatatatatatat. The strange wheel seems to vibrate and slowly starts turning continuously.", ACHIEV = "Stuntman" },
	[16153] = { NAME = "Ironblight", ID = 29, BREAK = false, TYPE = TYPE_MONSTER, CHANCE = 30, FAIL_MSG = { { 1, "The ironblight managed to run away." }, { 2, "Oh no! The magnet lost its power!" }, { 3, "The ironblight is fighting against the magnetic force." } }, SUCCESS_MSG = "You tamed the ironblight.", ACHIEV = "Magnetised" },
	...
	[14143] = { NAME = "Ladybug", ID = 27, BREAK = false, TYPE = TYPE_MONSTER, CHANCE = 30, FAIL_MSG = { { 1, "The ladybug got scared and ran away." }, { 3, "The ladybug is trying to nibble." } }, SUCCESS_MSG = "You tame a lady bug.", ACHIEV = "Lovely Dots" },
	[16154] = {
		NAME = "Magma Crawler",
		ID = 30,
		BREAK = false,
	...
	[14142] = { NAME = "Manta Ray", ID = 28, BREAK = false, TYPE = TYPE_MONSTER, CHANCE = 30, FAIL_MSG = { { 1, "The manta ray fled." }, { 3, "The manta ray is trying to escape." } }, SUCCESS_MSG = "You have tamed the manta ray.", ACHIEV = "Beneath the Sea" },
	[12306] = { NAME = "Midnight Panther", ID = 5, BREAK = false, TYPE = TYPE_MONSTER, CHANCE = 20, FAIL_MSG = { { 1, "The panther has escaped." }, { 2, "The whip broke." } }, SUCCESS_MSG = "You have tamed the panther.", ACHIEV = "Starless Night" },
	...
	[27605] = { NAME = "Mole", ID = 119, BREAK = false, TYPE = TYPE_MONSTER, CHANCE = 30, FAIL_MSG = { { 2, "The Mole is a bit capricious. Maybe I should leave it alone." }, { 4, "The Mole is a bit capricious. Maybe I should leave it alone." } }, SUCCESS_MSG = "You tamed the mole.", ACHIEV = "Up the Molehill" },
	...
	[12549] = { NAME = "Panda", ID = 19, BREAK = false, TYPE = TYPE_MONSTER, CHANCE = 40, FAIL_MSG = { { 4, "Panda the leaves and ran away." } }, SUCCESS_MSG = "You have tamed the panda.", ACHIEV = "Chequered Teddy" },
	[12509] = { NAME = "Sandstone Scorpion", ID = 21, BREAK = false, TYPE = TYPE_MONSTER, CHANCE = 40, FAIL_MSG = { { 1, "The scorpion has vanished." }, { 2, "Scorpion broken the sceptre." } }, SUCCESS_MSG = "You have tamed the scorpion.", ACHIEV = "Golden Sands" },
	[20274] = { NAME = "Shock Head", ID = 42, BREAK = false, TYPE = TYPE_MONSTER, CHANCE = 30, FAIL_MSG = { { 1, "The shock head ran away." }, { 3, "The shock head is growling at you." } }, SUCCESS_MSG = "You tamed the shock head.", ACHIEV = "Personal Nightmare" },
	...
	[12519] = { NAME = "Slug", ID = 14, BREAK = false, TYPE = TYPE_MONSTER, CHANCE = 40, FAIL_MSG = { { 1, "The slug has run away." }, { 3, "The drug had no effect." } }, SUCCESS_MSG = "You have tamed the slug.", ACHIEV = "Slugging Around" },
	[12311] = { NAME = "Terror Bird", ID = 2, BREAK = false, TYPE = TYPE_MONSTER, CHANCE = 15, FAIL_MSG = { { 1, "The bird ran away." }, { 3, "The terror bird is pecking you." } }, SUCCESS_MSG = "You have tamed the bird.", ACHIEV = "Pecking Order" },
	[12304] = { NAME = "Undead Cavebear", ID = 12, BREAK = false, TYPE = TYPE_MONSTER, CHANCE = 40, FAIL_MSG = { { 1, "The undead bear has run away." } }, SUCCESS_MSG = "You have tamed the skeleton.", ACHIEV = "Out of the Stone Age" },
	[12320] = { NAME = "Wailing Widow", ID = 1, BREAK = false, TYPE = TYPE_MONSTER, CHANCE = 40, FAIL_MSG = { { 1, "The widow has run away." }, { 2, "The widow has eaten the sweet bait." } }, SUCCESS_MSG = "You have tamed the widow.", ACHIEV = "Spin-Off" },
	[21186] = { NAME = "Walker", ID = 43, BREAK = false, TYPE = TYPE_MONSTER, CHANCE = 30, FAIL_MSG = { { 2, "This walker is incompatible with your control unit." }, { 4, "This walker is incompatible with your control unit." } }, SUCCESS_MSG = "You tamed the walker.", ACHIEV = "Gear Up" },
	[17858] = { NAME = "Water Buffalo", ID = 35, BREAK = false, TYPE = TYPE_MONSTER, CHANCE = 30, FAIL_MSG = { { 1, "The water buffalo got scared and ran away." }, { 3, "The water buffalo is trying to nibble." } }, SUCCESS_MSG = "You tamed a water buffalo.", ACHIEV = "Swamp Beast" },
	...
	[34258] = { NAME = "White Lion", ID = 174, BREAK = false, TYPE = TYPE_MONSTER, CHANCE = 50, FAIL_MSG = { { 1, "The White Lion runs away." }, { 2, "The White Lion ate the flower." } }, SUCCESS_MSG = "You have tamed the white lion.", ACHIEV = "Well Roared, Lion!" },
