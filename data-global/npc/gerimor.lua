...
local function creatureSayCallback(npc, creature, type, message)
	...
	if MsgContains(message, "missions") then
		...
		elseif player:getStorageValue(Storage.Quest.U11_40.CultsOfTibia.FinalBoss.Mission) == 2 then
			...
			npcHandler:say("Which of the following topics are you interested in? Cult of Life, Cult of Prosperity, Cult of the Minotaurs, Cult of the Barkless, Cult of the Misguided, Cult of the Orcs, Cult of the Humans?", npc, creature)
